...
def build_thread_summary(conn, email_id: int) -> tuple[int, str] | None:
    ...
    user_message = (
        ...
        "SUMMARY\n"
        "[A dated timeline, oldest first. For each meaningful event use EXACTLY this shape:\n"
        "<DD Mon YYYY, h:MM AM/PM>\n"
        "<one or two short sentences on what happened that day>\n"
        "Leave a blank line between entries. Use the real dates and times from the emails. "
